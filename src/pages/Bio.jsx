...
export function Bio() {
  return (
    <section>
      <h1>About Me</h1>
      <p>Hello, I’m Joey Sandoval—a dedicated programmer and aspiring computer engineer with a strong foundation in software development and computer science. I graduated from Sonoma State University in 2023 with a Master of Arts and recently sharpened my full-stack skills through Oregon State University’s intensive Programming Boot Camp for Webpage Design.
